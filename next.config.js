...
const nextConfig = {
  ...
  // Add CSP headers for Firestore and security
  async headers() {
    return [
      {
        source: '/(.*)',
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' https://firestore.googleapis.com https://*.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://www.google.com https://www.gstatic.com",
