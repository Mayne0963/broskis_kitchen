          ...
          {isLoading && (
            <div className="flex justify-start mb-4">
              <div className="flex max-w-[80%]">
                <div className="w-8 h-8 bg-gold-foil rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                  <FaRobot className="text-black text-sm" />
                </div>
                <div className="bg-[#333333] text-white p-3 rounded-lg">
                  <div className="flex items-center space-x-2">
                    <div className="flex space-x-1">
                      <div className="w-2 h-2 bg-gold-foil rounded-full animate-bounce" />
                      <div className="w-2 h-2 bg-gold-foil rounded-full animate-bounce" style={{ animationDelay: "0.1s" }} />
                      <div className="w-2 h-2 bg-gold-foil rounded-full animate-bounce" style={{ animationDelay: "0.2s" }} />
                    </div>
                    <span className="text-sm text-gray-300">BroskiBot is thinking...</span>
                  </div>
                </div>
              </div>
            </div>
